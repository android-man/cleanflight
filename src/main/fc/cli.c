...
static const clivalue_t valueTable[] = {
    ...
    { "current_meter_type",         VAR_UINT8  | MASTER_VALUE | MODE_LOOKUP,  &batteryConfig()->currentMeterSource, .config.lookup = { TABLE_CURRENT_METER } },
    { "voltage_meter_type",         VAR_UINT8  | MASTER_VALUE | MODE_LOOKUP,  &batteryConfig()->voltageMeterSource, .config.lookup = { TABLE_VOLTAGE_METER } },
